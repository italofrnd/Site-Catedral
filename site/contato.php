...
<ul>
    ...
    <div class="row empresa">
    	<div class="col-lg-6 col-sm-6 text-center">
			...
			<p class="titulo2">Caso deseje adquirir o nosso sistema, fale com um consultor:</p>	
            <div class="fonesContato">
            	<p>O nosso atendimento é de seg a sexta - 09:00 às 18:00h</p>
            	<p>
                	<img src="arquivos/img/iconMiniFone.png" class="dotbr1" />(61) 3202-6464
                	<img src="arquivos/img/iconMiniCelular.png" class="dotbr2" />(61) 9 9805-4064
                </p>
            </div>
            <div class="fonesContato p3">
        ...
        <div class="col-lg-6 col-sm-6 text-center">
            <p class="titulo">Envie-nos uma mensagem</p>
            <form action="arquivos/functions/controle2.php" method="post" name="formContato">
				<fieldset>
                    ...
                    <div class="form-group">
						<textarea class="form-control" id="mensagem" name="mensagem" rows="5" class="mensagemContato">Mensagem</textarea>
                    </div>
                    ...
                    <div class="form-group">
                  	...
                  	<div class="form-group" style="position:relative; top:15px;">
                        <input type="button" name="queroFalar" id="queroFalar" class="btn btn-primary btFalarEspecialista" value="Enviar Mensagem" onClick="valida()">
					</div>
				</fieldset>
			</form>
        </div>
