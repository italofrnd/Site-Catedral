...
<ul>
    ...
    <div class="row empresa">
    	<div class="col-lg-12 col-sm-12 text-center">
            <p class="titulo">São Mais de 8 Anos no Mercado de Automação Conquistamos Brasília e estamos rumo a todo o Brasil</p>
        </div>
    </div>
    ...
    <div class="row painel">
        <div class="col-lg-12 col-sm-12 text-left">
            <p class="titulo2">
                A Catedral Automação, com sede em Brasília, possui mais de 8 anos no Mercado com mais de 1200 empresas usando o seu sistema dos mais diversos tipos de negócio.
            </p>
            <p class="titulo2">
                Com um serviço de qualidade e praticidade, proporcionando segurança  e controle para os estabelecimentos e os empresários
            </p>

            <p class="titulo2 p3">
                O nosso atendimento se dá por uma equipe de suporte técnico especializado que funciona também nos feriados e finais de semana. Sempre 24 horas por 7 dias. Esse é um dos nossos principais diferenciais!
            </p>

            <p class="titulo2">
                A nossa empresa nasceu dentro de um estabelecimento comercial, esse foi o nosso excelente laboratório. Inicialmente como um aplicativo simples de vendas e controle de estoque.
            </p>
            <p class="titulo2">
                Quando vimos o potencial do sistema pela praticidade que oferecia, apostamos na ideia!
            </p>
            <p class="titulo2">
                Criamos a empresa, composta de três sócios, fizemos com que o sistema se tornasse mais robusto e completo, e hoje atendemos diversos tipos de estabelecimentos.
            </p>
        </div>
    </div>
