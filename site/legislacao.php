...
<ul>
    ...
    <div class="row empresa">
    	<div class="col-lg-12 col-sm-12 text-center">
            <p class="titulo">Nosso Portal de Notícias</p>
            <p class="titulo2">Tenha acesso as notícias de interesse do seu negócio nos mais variados assuntos</p>
        </div>
    </div>
			...
			<div class="tabs-container">
    			...
    			<ul class="nav nav-tabs tab-border-top-danger">
            		<li class="active dropdown">
                    	<a class="dropdown-toggle" data-toggle="dropdown" href="#">Legislação
                        <span class="caret"></span></a>
                		<ul class="dropdown-menu">
                  			<li style="color:#FFF; font-size:13px; font-weight:bold; margin-left:23px; background-color:#eca00b;">
                                <a data-toggle="tab" href="#tab-1" style="margin-left:-2px;">MP 764/16</a>
                            </li>
                            <li style="color:#FFF; font-size:13px; font-weight:bold; margin-left:23px; background-color:#eca00b;">
                                <a data-toggle="tab" href="#tab-2" style="margin-left:-2px;">DECRETO 37893/16</a>
                            </li>
                            <li style="color:#FFF; font-size:13px; font-weight:bold; margin-left:23px; background-color:#eca00b;">
                                <a data-toggle="tab" href="#tab-3" style="margin-left:-2px;">LEI 12.741/12</a>
                            </li>
                		</ul>
                    </li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                    	<a href="diversos.php">Diversos</a>
                    </li>
            	</ul>
                ...
                <div class="tab-content">
            		...
            		<div id="tab-1" class="tab-pane active">
            			<div class="panel-body text-left">
                        	<p class="titulo2">&nbsp;</p>
            				<p class="titulo3"><strong>MEDIDA PROVISÓRIA N° 764, DEZ/16</strong></p>
            				<p class="fontSize1"><strong>Desconto no Pagamento À Vista</strong></p>
                            
                            <p>&nbsp;</p>
                            <p>Art. 1º Fica autorizada a diferenciação de preços de bens e serviços oferecidos ao público, em função do prazo ou do instrumento de pagamento utilizado.</p>
                            <p>A MPV-764/16 permite que as empresas cobrem preços diferenciados, considerando a forma de recebimento. Exemplo: à vista ou com cartão de débito ou crédito. Também poderão ser cobrados preços diferenciados considerando compras à vista ou a prazo (em uma ou mais parcelas).</p>
                            
                            <p>&nbsp;</p>
                            <p>O Sistema Catedral está preparado para atender esta Medida Provisória de três diferentes formas:</p>
                            <p>- Teclando F7 para dar desconto no lançamento dos itens (o desconto será aplicado somente em um item, no momemto da venda).</p>
                            <p>- Teclando F8 para dar desconto no recebimento da conta (o desconto será distribuído proporcionalmente a todos os itens, no momento do recebimento da conta).</p>
                            <p>- Criando-se uma ou mais tabelas utilizando a opção “CADASTRO | Produto / Serviço”. O Catedral permite até 6 valores diferentes para o mesmo produto (tabela 1 a 6). Permite também três valores calculados a partir de descontos pré cadastrados (tabela 7 a 9).</p>
                            
                            <p>&nbsp;</p>
                            <p>A Catedral Automação recomenda o uso descrito nos itens 1 e 2, neste caso os descontos serão concedidos apenas quando solicitados pelos clientes. No caso de criação de tabelas (item 3) poderão ser concedidos descontos a todas as compras.</p>
                            
                            <p>&nbsp;</p>
                            <p>OBS: A Medida Provisória 764/16 depende de aprovação do Congresso Nacional. Poderá perder sua eficácia se não for convertida em Lei pelo Congresso Nacional. Fique atento, pois, nesse caso, não será permitido cobrar valores diferenciados no recebimento.</p>
                            
                            <p>&nbsp;</p>
                            <p><img src="arquivos/img/MP76416.jpg" class="imgMP" /></p>
                            
                            <p>&nbsp;</p>
                            <p><strong>Em caso de dúvida entre em contato com o Suporte Catedral: 3202 6464 ou 99854-21993, nossos técnicos terão prazer em dirimir suas dúvidas.</strong></p>
            			</div>
            		</div>
                    ...
                    <div id="tab-2" class="tab-pane">
            			<div class="panel-body text-left">
                        	<p class="titulo2">&nbsp;</p>
                        	<p class="titulo3"><strong>DECRETO 37.893, DE 27/12/2016.</strong></p>
            				<p class="fontSize1"><strong>Isenção de Impostos sobre Gorjetas.</strong></p>
                            
                            <p>&nbsp;</p>
                            <p>"Art. 7º-B. Fica excluída da base de cálculo do imposto o valor da gorjeta relativa ao fornecimento de alimentação e bebidas por bares, restaurantes, hotéis e estabelecimentos similares, desde que limitada a 10% do valor da conta."</p>
                            <p>§ 1º Na hipótese do caput, o valor da gorjeta deverá ser discriminado no respectivo documento fiscal.</p>
                            <p>Para atendimento dessa determinação, no Sistema Catedral, torna-se necessária a criação de um produto, que será vinculado com o pagamento de gorjeta (verifique se já não foi criado).</p>
                            <p>Para cadastrar o produto (que pode ter o nome de "gorjeta" ou "taxa de serviço") utilize o menu <strong>CADASTRO | Produto / Serviço</strong> e escolha a Situação Tributária como <strong>"Isento de ISS"</strong>. Veja abaixo como deverá ser configurada a Situação Tributária no <strong>ECF</strong> ou no <strong>NFCe</strong>:</p>
                            
                            <p>&nbsp;</p>
                            <p><strong>1 - ECF – Emissor de Cupom Fiscal</strong></p>
                            <p><img src="arquivos/img/EFC.jpg" width="558" height="277" class="imgEFC" /></p>
                            
                            <p>&nbsp;</p>
                            <p><strong>2 - NFCe – Nota Fiscal Cupom Eletrônico</strong></p>
                            <p><img src="arquivos/img/nfce.jpg" width="582" height="208" class="imgNFCE" /></p>
                            
                            <p>&nbsp;</p>
                            <p>Após o cadastramento do produto, entrar no menu:</p>
                            <p><img src="arquivos/img/gorjeta.jpg" width="370" height="75" class="imgGorjeta" /></p>
                            
                            <p>&nbsp;</p>
                            <p>A partir desse momento, o Sistema Catedral irá calcular o valor da gorjeta e informá-lo no Cupom Fiscal ou NFCe, isentando-o de impostos.</p>
                            
                            <p>&nbsp;</p>
                            <p>OBS: O pagamento da gorgeta é <strong>facultativo</strong>; dessa forma, só deverá ser discriminado no documento fiscal se o cliente tiver concordado e efetivamente realizado o pagamento.</p>
                    ...
                    <div id="tab-3" class="tab-pane">
            			<div class="panel-body text-left">
                        	<p class="titulo2">&nbsp;</p>
                        	<p class="titulo3"><strong>LEI 12.741/12</strong></p>
            				<p class="fontSize1"><strong>Exibição de Alíquotas no Comprovante de Pagamento</strong></p>
                            
                            <p>&nbsp;</p>
                            <p>A Catedral Automação informa a seus clientes e parceiros que já está sendo fiscalizado o cumprimento da Lei 12.741/2012. O Sistema Catedral encontra-se em conformidade com a referida Lei há mais de dois anos; entretanto, faz-se necessário o cadastramento das alíquotas para que as informações sejam impressas no Cupom Fiscal e Nota Fiscal Eletrônica.</p>
                            <p>Verifique se sua NFE – Nota Fiscal Eletrônica e/ou Cupom Fiscal estão em conformidade com a Lei 12.741/12:</p>
                            
                            <p>&nbsp;</p>
                            <p>
                            	<a href="https://www.youtube.com/watch?v=9wy9XvgTE0Q" class="page-scroll btn btn-primary" target="_blank">1. NFe</a>
                        		<a href="https://www.youtube.com/watch?v=kVLGZI39oOw" class="page-scroll btn btn-primary" target="_blank">2. Cupom Fiscal</a>
                        	</p>
