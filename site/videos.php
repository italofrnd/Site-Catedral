...
<ul>
    ...
    <div class="row empresa">
    	<div class="col-lg-12 col-sm-12 text-center">
            <p class="titulo">Vídeos Sistema Catedral</p>
            <p class="titulo2">Tenha acesso aos nossos tutoriais e treinamentos</p>
        </div>
    </div>
    
    <div class="row painel">
        <div class="col-lg-3 col-sm-3 text-center">
            <p class="titulo4">OPERADOR DE CAIXA</p>
            <p class="titulo4">
                <a href="verVideo.php?v=EBwd_Fc1VmI" target="_blank"><img src="arquivos/img/videos/operadorDeCaixa1.jpg" class="imgVideo" /> Operador de Caixa</a>
            </p>
        </div>
        <div class="col-lg-3 col-sm-3 text-center">
        	<p class="titulo4">CONTROLE DE ESTOQUE</p>
            <p class="titulo4">
                <a href="verVideo.php?v=U_5lfKG-6vo" target="_blank"><img src="arquivos/img/videos/controleEstoque1.jpg" class="imgVideo" />01 - Visão Geral</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=SK9WbyawYqw" target="_blank"><img src="arquivos/img/videos/controleEstoque2.jpg" class="imgVideo" />02 - Revisar Estoque</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=CWfcQipz2f8" target="_blank"><img src="arquivos/img/videos/controleEstoque3.jpg" class="imgVideo" />03 - Entrada Estoque</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=bDsYQTh4gEI" target="_blank"><img src="arquivos/img/videos/controleEstoque4.jpg" class="imgVideo" />04 - Entrada Compra</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=fSS3IgtTvOw" target="_blank"><img src="arquivos/img/videos/controleEstoque5.jpg" class="imgVideo" />05 - Compra NFE Entrada</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=93UMy_tpyn0" target="_blank"><img src="arquivos/img/videos/controleEstoque6.jpg" class="imgVideo" />06 - Saida Estoque</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=583095q7cAI" target="_blank"><img src="arquivos/img/videos/controleEstoque7.jpg" class="imgVideo" />07 - Composição de Venda</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=M58HMkqDr7M" target="_blank"><img src="arquivos/img/videos/controleEstoque8.jpg" class="imgVideo" />08 - Listagem Estoquea</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=a0gmTT1AQ48" target="_blank"><img src="arquivos/img/videos/controleEstoque9.jpg" class="imgVideo" />09 - Contagem Estoque</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=Px7NFvo0DWE" target="_blank"><img src="arquivos/img/videos/controleEstoque10.jpg" class="imgVideo" />10 - Estoque Compra</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=Yn9ZFVvJxIM" target="_blank"><img src="arquivos/img/videos/controleEstoque11.jpg" class="imgVideo" />11 - Pedido de Compra</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=JdzD42jGTn4" target="_blank"><img src="arquivos/img/videos/controleEstoque12.jpg" class="imgVideo" />12 - Pesquisa Movimento Produto</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=BrXfiuHpZ0Y" target="_blank"><img src="arquivos/img/videos/controleEstoque13.jpg" class="imgVideo" />13 - Capital Retido no Estoque</a>
            </p>
        </div>
        <div class="col-lg-3 col-sm-3 text-center">
        	<p class="titulo4">FINANÇAS</p>
            <p class="titulo4">
                <a href="verVideo.php?v=zdpAk44NC3E" target="_blank"><img src="arquivos/img/videos/Financas1.jpg" class="imgVideo" />01 - Alterar Forma Recebimento</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=ImvOh47Mkwo" target="_blank"><img src="arquivos/img/videos/Financas2.jpg" class="imgVideo" />02 - Contas a Pagar</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=yhIgdZ4palI" target="_blank"><img src="arquivos/img/videos/Financas3.jpg" class="imgVideo" />03 - Contas a Receber</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=EOzoYP98kmo" target="_blank"><img src="arquivos/img/videos/Financas4.jpg" class="imgVideo" />04 - Contas a Receber Cartão</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=SFm2UNxj1JA" target="_blank"><img src="arquivos/img/videos/Financas5.jpg" class="imgVideo" />05 - Fluxo de Caixa</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=P25eyUjDjxA" target="_blank"><img src="arquivos/img/videos/Financas6.jpg" class="imgVideo" />06 - Movimento Conta Corrente</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=LOpXURY1BYM" target="_blank"><img src="arquivos/img/videos/Financas7.jpg" class="imgVideo" />07 - Agenda Financeira</a>
            </p>
        </div>
        <div class="col-lg-3 col-sm-3 text-center">
        	<p class="titulo4">CADASTROS</p>
            <p class="titulo4">
                <a href="verVideo.php?v=arg_FvTdZns" target="_blank"><img src="arquivos/img/videos/Cadastro1.jpg" class="imgVideo" />01 - Cliente</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=i49cgeqoMAs" target="_blank"><img src="arquivos/img/videos/Cadastro2.jpg" class="imgVideo" />02 - Conta Corrente</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=rWejMIlcoqk" target="_blank"><img src="arquivos/img/videos/Cadastro3.jpg" class="imgVideo" />03 - Fornecedor</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=Iq2jx3WyCgw" target="_blank"><img src="arquivos/img/videos/Cadastro4.jpg" class="imgVideo" />04 - Função</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=cocvsLFM_SE" target="_blank"><img src="arquivos/img/videos/Cadastro5.jpg" class="imgVideo" />05 - Funcionário</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=3DVtqoVz_zY" target="_blank"><img src="arquivos/img/videos/Cadastro6.jpg" class="imgVideo" />06 - Grupo Produto</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=QdtagNWy-IY" target="_blank"><img src="arquivos/img/videos/Cadastro7.jpg" class="imgVideo" />07 - Motivo Estorno</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=nk_yIzYT08g" target="_blank"><img src="arquivos/img/videos/Cadastro8.jpg" class="imgVideo" />08 - Obs Lancamento</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=YOBrEbTlPoc" target="_blank"><img src="arquivos/img/videos/Cadastro9.jpg" class="imgVideo" />09 - Operador</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=N3YBLtpbE8w" target="_blank"><img src="arquivos/img/videos/Cadastro10.jpg" class="imgVideo" />10 - Produto</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=rxQ-f8F2gfg" target="_blank"><img src="arquivos/img/videos/Cadastro11.jpg" class="imgVideo" />11 - Serviço</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=u2l2Om5nUPY" target="_blank"><img src="arquivos/img/videos/Cadastro12.jpg" class="imgVideo" />12 - Tipo Cliente</a>
            </p>
            <p class="titulo4">
                <a href="verVideo.php?v=JzTMZK8WeBo" target="_blank"><img src="arquivos/img/videos/Cadastro13.jpg" class="imgVideo" />13 - Unidade Medida</a>
            </p>
        </div>
    </div>
