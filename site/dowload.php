...
<ul>
    ...
    <div class="row painel">
        <div class="col-lg-12 col-sm-12 text-center">
            <p class="titulo2">
               <img src="arquivos/img/winrar.png" /> <a href="arquivos/software/wrar550.exe" style="color: #000; text-decoration: none;">Software WinRar</a>
            </p>
            <p class="titulo2 p3">&nbsp;</p>
            <p class="titulo2">
               <img src="arquivos/img/logoTeamViewer.jpg" /> <a href="http://www.s75.com.br/ctdrl/prgrm/TeamViewerQS.exe" style="color: #000; text-decoration: none;">Software Team Viewer</a>
            </p>
            <p class="titulo2 p3">&nbsp;</p>
            <p class="titulo2 p3">&nbsp;</p>
            <p class="titulo2 p3">&nbsp;</p>
