...
<ul>
    ...
    <div class="row empresa">
    	<div class="col-lg-6 col-sm-6 text-center">
			...
			<p class="titulo2">Suporte Técnico</p>	
            ...
            <div class="fonesContato">
                <div class="fonesContato3" style="position:relative; top:-20px;">
        ...
        <div class="col-lg-6 col-sm-6 text-center">
            <p class="titulo">Envie-nos sua Dúvida ou Problema</p>
            <form action="arquivos/functions/controle3.php" method="post" name="formContato">
				<fieldset>
                    ...
                    <div class="form-group">
						<textarea class="form-control" id="mensagem" name="mensagem" rows="5" class="mensagemContato">Dúvida</textarea>
                    </div>
